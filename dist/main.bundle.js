...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__graphs_graphs_component__ = __webpack_require__("../../../../../src/app/graphs/graphs.component.ts");
...
var routes = [
    ...
    {
        path: 'graphs',
        component: __WEBPACK_IMPORTED_MODULE_2__graphs_graphs_component__["a" /* GraphsComponent */],
    },
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__graphs_graphs_component__ = __webpack_require__("../../../../../src/app/graphs/graphs.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__userdata_service__ = __webpack_require__("../../../../../src/app/userdata.service.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_6__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_3_ng2_nvd3__["NvD3Component"], __WEBPACK_IMPORTED_MODULE_7__welcome_welcome_component__["a" /* WelcomeComponent */], __WEBPACK_IMPORTED_MODULE_8__graphs_graphs_component__["a" /* GraphsComponent */]
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__angular_material__["b" /* MatButtonToggleModule */]
            // mongoose
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_9__userdata_service__["a" /* UserdataService */]],
...
/***/ "../../../../../src/app/graphs/graphs.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/graphs/graphs.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"main-div\">\n  <mat-card class=\"example-card\">\n    <mat-card-title>Speeches by {{userName}}</mat-card-title>\n    <!-- <ul> -->\n      <div *ngFor=\"let speech of speeches\">\n        <div *ngIf=\"userName == speech.user\">\n          <h2>{{ speech.name }}</h2>\n          <div *ngFor=\"let recording of recordings; let i = index\">\n            <div *ngIf=\"speech.recordings.includes(recording._id)\">\n              <h3>Recording {{i+1}}</h3>\n              <p>Presentation Length: {{recording.duration}}</p>\n              <p>Filler Words Used: {{recording.filler}}</p>\n              <p>Word Count: {{recording.wordCount}}</p>\n            </div>\n          </div>\n        </div>\n      </div>\n    <h1>Filler Words Used Per Recording</h1>\n    <!-- </ul> -->\n    <div class=\"col-md-6\">\n      <canvas baseChart\n                  [datasets]=\"lineChartData\"\n                  [labels]=\"lineChartLabels\"\n                  [legend]=\"lineChartLegend\"\n                  [options]=\"lineChartOptions\"\n                  [chartType]=\"lineChartType\"\n                  (chartHover)=\"chartHovered($event)\"\n                  (chartClick)=\"chartClicked($event)\"></canvas>\n    </div>\n    <div class=\"col-md-12 text-center\" style=\"margin-top: 10px;height: 50%\">\n      <button mat-raised-button (click)=\"randomizeType()\" style=\"display: inline-block\">\n        {{lineChartType == \"bar\" ? \"Bar\" : \"Line\"}}\n      </button>\n    </div>\n</mat-card>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__userdata_service__ = __webpack_require__("../../../../../src/app/userdata.service.ts");
...
var GraphsComponent = (function () {
    function GraphsComponent(userDataService) {
        var _this = this;
        ...
        this.userDataService.getSpeeches().subscribe(function (res) {
            console.log(res);
            _this.speeches = res.data;
            _this.recordingIds = _this.speeches.recordings;
        });
        this.userDataService.getRecordings().subscribe(function (res) {
            console.log(res);
            _this.recordings = res.data;
            var fillerData = { data: [], label: "Filler Words" };
            console.log(_this.recordings);
            for (var i = 0; i < _this.recordings.length; ++i) {
                fillerData.data.push(+_this.recordings[i].filler);
                if (i > _this.lineChartLabels.length) {
                    _this.lineChartLabels.push(i);
                }
            }
            _this.lineChartData[0] = fillerData;
...
GraphsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-graphs',
        template: __webpack_require__("../../../../../src/app/graphs/graphs.component.html"),
        styles: [__webpack_require__("../../../../../src/app/graphs/graphs.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__userdata_service__["a" /* UserdataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__userdata_service__["a" /* UserdataService */]) === "function" && _b || Object])
], GraphsComponent);
...
var UserdataService = (function () {
    ...
    UserdataService.prototype.updateUser = function (username) {
        this.username = username;
    };
    UserdataService.prototype.getSpeeches = function () {
        var _this = this;
        return this.http.get("/api/speeches")
            .map(function (result) { return _this.result = result; });
    };
    UserdataService.prototype.getRecordings = function () {
        var _this = this;
        return this.http.get("/api/recordings")
            .map(function (result) { return _this.result = result; });
    };
...
module.exports = "<div class=\"main-div\">\n  <mat-card class=\"example-card\">\n    <mat-card-title>\n      Articulate\n    </mat-card-title>\n    <img mat-card-mat-image src=\"../../assets/articulate.png\" style=\"width:200px; height: 200px\">\n    <form class=\"example-form\">\n        <mat-form-field class=\"example-full-width\">\n          <input matInput type=\"text\" placeholder=\"Enter your user name\" #userInput>\n        </mat-form-field>\n        <a mat-raised-button type=\"submit\" (click)=\"loadData(userInput.value)\">Load Data</a>\n    </form>\n  </mat-card>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__userdata_service__ = __webpack_require__("../../../../../src/app/userdata.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WelcomeComponent = (function () {
    function WelcomeComponent(router, userDataService) {
        this.router = router;
        this.userDataService = userDataService;
    }
    WelcomeComponent.prototype.ngOnInit = function () {
    };
    WelcomeComponent.prototype.loadData = function (user) {
...
WelcomeComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__userdata_service__["a" /* UserdataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__userdata_service__["a" /* UserdataService */]) === "function" && _b || Object])
], WelcomeComponent);
